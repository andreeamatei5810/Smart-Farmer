...
public class ProductsFragmentMonthly extends Fragment implements RVAdapterShop.OnItemListener, RVAdapterSubs.OnItemListener{
    ...
    static String type;
    public ProductsFragmentMonthly() {
        // Required empty public constructor
    }

    public static ProductsFragmentMonthly newInstance(String type1) {
        ProductsFragmentMonthly fragment = new ProductsFragmentMonthly();
        type = type1;
        return fragment;
    }
    ...
    private void initRecycleView(View view){
        ...
        if(type.equals("shop")) {
            list = dbHelper.getAllProductsFromShopCart(emailUserLog, "Monthly");
            ...
            if (cursor.getCount() != 0) {
                ...
                if (cursor.getString(4).equals("client")) {
                    list1 = dbHelper.getAllProductsFromSubs(emailUserLog, "Monthly");
                }
                else{
                    list1 = dbHelper.getAllProductsFromSubsForFarmer(emailUserLog, "Monthly");
                }
