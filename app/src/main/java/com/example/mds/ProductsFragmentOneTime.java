...
public class ProductsFragmentOneTime extends Fragment implements RVAdapterShop.OnItemListener, RVAdapterSubs.OnItemListener{
    ...
    static String type;
    public ProductsFragmentOneTime() {
        // Required empty public constructor
    }

    public static ProductsFragmentOneTime newInstance(String type1) {
        ProductsFragmentOneTime fragment = new ProductsFragmentOneTime();
        type = type1;
        return fragment;
    }
    ...
    private void initRecycleView(View view){
        ...
        if(type.equals("shop")) {
            list = dbHelper.getAllProductsFromShopCart(emailUserLog, "One time");
            ...
            if (cursor.getCount() != 0) {
                ...
                if (cursor.getString(4).equals("client")) {
                    list1 = dbHelper.getAllProductsFromSubs(emailUserLog, "One time");
                }
                else{
                    list1 = dbHelper.getAllProductsFromSubsForFarmer(emailUserLog, "One time");
                }
