...
public class ProductsFragmentWeekly extends Fragment implements RVAdapterShop.OnItemListener, RVAdapterSubs.OnItemListener{
    ...
    public ProductsFragmentWeekly() {
        // Required empty public constructor
    }

    public static ProductsFragmentWeekly newInstance(String type1) {
        ProductsFragmentWeekly fragment = new ProductsFragmentWeekly();
        type = type1;
        return fragment;
    }
    ...
    private void initRecycleView(View view){
        ...
        if(type.equals("shop")) {
            list = dbHelper.getAllProductsFromShopCart(emailUserLog, "Weekly");
            ...
            if (cursor.getCount() != 0) {
                ...
                if (cursor.getString(4).equals("client")) {
                    list1 = dbHelper.getAllProductsFromSubs(emailUserLog, "Weekly");
                }
                else{
                    list1 = dbHelper.getAllProductsFromSubsForFarmer(emailUserLog, "Weekly");
                }
